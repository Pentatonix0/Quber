...
const TeachingPageQuestsContent = () => {
    ...
    const getAllQuests = async () => {
        try {
            const response = await axios.get(
                `/api/quests/${token.user_id}/get-all-created-quests`,
                {
                    headers: {
        ...
        <div className="px-10 py-5 w-full max-w-7xl bg-white rounded-xl">
            <div className="mb-8">
                ...
                <p className="mt-2 text-gray-500">
                    Список созданных учебных квестов
                </p>
            </div>
...
export default TeachingPageQuestsContent;
